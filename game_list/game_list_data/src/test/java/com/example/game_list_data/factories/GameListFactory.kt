...
import com.example.game_list_data.sources.models.*
...
object GameListFactory {
    ...
    fun getGameListRemoteModel(page: Int): GameListRemoteModel {
        return GameListRemoteModel(
            next = "https://api.rawg.io/api/games?key=b93e15401f5e4b6ba8e982d50e192f75&page=2&page_size=20",
            previous = null,
            results = listOf(
                GameLight(
                    ...
                    genres = listOf(Genre(name = "Action"), Genre(name = "Adventure"))
                ), GameLight(
                    id = 3328,
                    name = "The Witcher 3: Wild Hunt",
                    ...
                    parentPlatforms = listOf(
                        ...
                        ParentPlatform(Platform(slug = "playstation")),
                        ParentPlatform(Platform(slug = "xbox")),
                        ParentPlatform(Platform(slug = "mac")),
                        ParentPlatform(Platform(slug = "linux"))
                    ),
                    genres = listOf(Genre(name = "Shooter"), Genre(name = "Puzzle"))
                ), GameLight(
                    id = 5286,
                    name = "Tomb Raider (2013)",
                    ...
                    genres = listOf(Genre(name = "Action"), Genre(name = "Shooter"))
                ), GameLight(
                    id = 5679,
                    name = "The Elder Scrolls V : Skyrim",
                    ...
                    genres = listOf(Genre(name = "Action"), Genre(name = "RPG"))
                ), GameLight(
                    id = 12020,
                    name = "Left4 Dead 2",
                    ...
                    genres = listOf(Genre(name = "Adventure"), Genre(name = "Puzzle"))
                ), GameLight(
                    id = 4062,
                    name = "BioShock Infinite",
                    ...
                    parentPlatforms = listOf(
                        ...
                        ParentPlatform(Platform(slug = "android")),
                        ParentPlatform(Platform(slug = "mac")),
                        ParentPlatform(Platform(slug = "linux"))
                    ),
                    genres = listOf(Genre(name = "Adventure"))
                )
            )
        )
    }
